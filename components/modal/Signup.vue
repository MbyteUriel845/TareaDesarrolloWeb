          ...
          <section class="p-5 rounded-b-2xl">
            ...
            <div v-if="isUserSignedUp">
              <div class="text-center">
                <div>
                  <p class="text-4xl">Bienvenido {{ name }}!</p>
                  <p class="text-2xl">Ahora eres un miembro</p>
                </div>
              </div>
            </div>
          </section>
...
export default {
  ...
  data () {
    return {
      ...
      modalTitleRegistered: 'Bienvenidoi ',
      primaryBtnLabel: 'Cerrar sesión',
      ...
      emailNotValidLabel: 'Se requiere un email valido',
      name: '',
      email: '',
      password: '',
      repeatPassword: '',
